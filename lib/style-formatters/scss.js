...
// Helpers
const { findUniqueVariables, findDefaultValueMismatches, rewriteVariables } = require('../helpers/variables');
const { addXMLNSAttributesToElement } = require('../helpers/attributes');
...
module.exports = (symbols = [], options = {}) => {
    ...
    const output = symbols.reduce((accumulator, symbol) => {
        ...
        addXMLNSAttributesToElement(symbol.attributes, svg);
